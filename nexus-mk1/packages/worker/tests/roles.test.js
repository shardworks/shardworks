...
import { loadRole, renderSystemPrompt, renderWorkPrompt, } from '../src/roles.js';
import { detectRateLimit, parseRetryAfter, buildArgs, formatEvent, } from '../src/launcher.js';
// ---------------------------------------------------------------------------
...
function writeRolesFile(roles = [SAMPLE_ROLE, PLANNER_ROLE]) {
